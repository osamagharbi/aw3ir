...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      ...
      ), _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"] //<-- Ajouter la référence ici aussi
      ],
      providers: [],
    ...
    function () {
      ...
      _createClass(MeteoDetailComponent, [{
        ...
        value: function getMeteo() {
          ...
          this.meteoService.getForcast(name).then(function (forcast) {
            return _this.forcast = forcast;
          }).catch(function (fail) {
            return _this.forcast = fail;
          });
        }
      }]);
  ...
  function srcAppServicesMeteoServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(MeteoService, [{
        ...
        key: "getForcast",
        value: function getForcast(name) {
          console.log('from service', name);
          var m = new _meteoItem__WEBPACK_IMPORTED_MODULE_2__["MeteoItem"]();
          return fetch('https://api.openweathermap.org/data/2.5/forecast/?q=' + name + '&lang=fr&units=metric&appid=0ada432b59deb9716c357092c5f79be6').then(function (response) {
            return response.json();
          }).then(function (json) {
            if (json.cod == "200") {
              var aujourdhui = json.list[0].dt_txt.split(' ')[0]; // filtrer 

              json.list = json.list.reduce(function (a, d) {
                if (!a.find(function (i) {
                  return i.dt_txt.split(' ')[0] == d.dt_txt.split(' ')[0];
                }) && d.dt_txt.split(' ')[0] !== aujourdhui) {
                  a.push(d);
                }
              ...
              m.weather = json;
              console.error('Forcast introuvable pour ' + name + ' (' + json.message + ')');
              return Promise.reject('Forcast introuvable pour ' + name + ' (' + json.message + ')');
            }
          });
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\GitHub\aw3ir\tp6\meteo-angular\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
