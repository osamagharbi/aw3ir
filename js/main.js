...
window.onload = function () {
    app = new Vue({
        ...
        computed: {
            imageURL() {
                return `https://maps.googleapis.com/maps/api/staticmap?markers=${this.cityWeather.coord.lat},${this.cityWeather.coord.lon}&zoom=5&size=400x300&scale=2&key=AIzaSyAkmvI9DazzG9p77IShsz_Di7-5Qn7zkcg`
            }
        },
        ...
        methods: {
            ...
            meteo : function (_city){
                ...
                fetch('https://api.openweathermap.org/data/2.5/weather?q='+_city.name+'&units=metric&lang=fr&apikey=93564c0bd2701749782f5b2a4856e9d0') 
